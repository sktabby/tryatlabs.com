    ...
    <footer className="ft">
      ...
      <div className="container">
        <div className="ftGrid">
          {/* LEFT COLUMN */}
          <div>
            <div className="ftBrand">{SITE.brand}</div>

            <div className="ftDesc">
              TryAtLabs is a fast, privacy-first productivity platform built to handle everyday digital
              tasks directly in your browser. No sign-ups, no downloads — just clean, reliable tools
              that work instantly on desktop and mobile.
            </div>

            <div className="ftSection">
              <div className="ftLabel">Privacy</div>
              <div className="ftText">
                Most tools run locally in your browser. Your content is not stored or tracked unless
                explicitly stated.
              </div>
            </div>
            ...
            <div className="ftSection">
              ...
              <div className="ftText">
                Tools are provided as-is for general utility purposes. Users are responsible for how
                outputs are used.
              </div>
            </div>
            ...
            <div className="ftSection">
              ...
              <div className="ftContactRow">
                <span>📧</span>
                <span>contact@tryatlabs.com</span>
              </div>

              <div className="ftContactRow">
                <span>🌐</span>
                <span>tryatlabs.com</span>
              </div>
